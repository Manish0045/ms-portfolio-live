...
const projects = [
    ...
    },
    {
        id: 4,
        title: "Vibro",
        description: "A web application built with Node.js and Express.js, using MySQL as the database. Vibro provides various products including doors and Electromagnetic Vibratory Bowl Feeders, Linear Feeders, Tables, Impact Vibrators, Sorting Tables.",
        imageUrl: vibroImage,
    },
    {
        id: 5,
